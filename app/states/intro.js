  ...
  Intro.prototype = {
    ...
    create: function() {
      ...
      this.instructionsText = this.game.add.text(this.game.world.centerX, 300, 'Rules:  Tap a word that matches the color of the lit up word.  If you get it right in time, the word will clear.\n\nTry to clear all the words.\n\nTap anywhere to start.', { font: '16px Arial', fill: '#ffffff', align: 'left', wordWrap: true, wordWrapWidth: this.game.width * 0.8});
